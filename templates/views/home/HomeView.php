    ...
    <div class="row">
          ...
          <div class="course-body">
            <div class="name-price">
              <div class="teacher-info">
                <img src="<?php echo IMAGES.'author1.jpg' ?>" alt="#">
      ...
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-course">
          ...
          <div class="course-body">
            <div class="name-price">
              <div class="teacher-info">
                <img src="<?php echo IMAGES.'author2.jpg'?>" alt="#">
      ...
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-course">
          <!-- Course Head -->
          <div class="course-head overlay">
            <img src="<?php echo IMAGES.'courses/course4.jpg'?>" alt="#">
            <a href="course-single.html" class="btn white primary">Register Now</a>
          </div>
          <!-- Course Body -->
          <div class="course-body">
        ...
        <div class="single-course">
          ...
          <div class="course-body">
            <div class="name-price">
              <div class="teacher-info">
                <img src="<?php echo IMAGES.'author2.jpg' ?>" alt="#">
        <?php echo IMAGES.' class="titl' ?>e">Jenola Protan</h4>
              </div>
              <span class="price">$290</span>
            </div>
            <h4 class="c-title"><a href="course-single.html">Learn Web Developments Course</a></h4>
      ...
      <div class="col-lg-8 col-md-8 col-12">
        <div class="client-slider">
          <div class="single-slider">
            <a href="#"><img src="<?php echo IMAGES.'client1.png' ?>" alt="#"></a>
          </div>
          <div class="single-slider">
            <a href="#"><img src="<?php echo IMAGES.'client2.png' ?>" alt="#"></a>
          </div>
          <div class="single-slider">
            <a href="#"><img src="<?php echo IMAGES.'client3.png' ?>" alt="#"></a>
          </div>
          <div class="single-slider">
            <a href="#"><img src="<?php echo IMAGES.'client4.png' ?>" alt="#"></a>
          </div>
          <div class="single-slider">
            <a href="#"><img src="<?php echo IMAGES.'client5.png' ?>" alt="#"></a>
          </div>
          <div class="single-slider">
            <a href="#"><img src="<?php echo IMAGES.'client1.png' ?>" alt="#"></a>
          </div>
